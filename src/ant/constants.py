...
REQUIRED_FIELDS = ["날짜", "거래처", "사업자등록번호", "대표자", "주소", "금액", "유형"]

RESULT_FIELDS = ["날짜", "거래처", "사업자등록번호", "대표자", "주소", "금액", "유형", "계정과목"]

CATEGORY = ["식비","헤어메이크업","뮤직비디오","OST","경호비","작곡/편곡","주택임차료","보컬레슨","리스/렌탈","차량렌트","리스/렌탈","마케팅","음원제작","운송비","번역비","세션비","세콤","의상세탁","장비수리","의상수선","주택임차료","스타일리스트","스타일링","안무","운반비","임차료","저작권","청소","출장비","콘서트","키워드","튠비","트랙비","판매대행수수료","팬미팅","편곡비","포토그래퍼","피부과","헤어시술","헬스","회의비"]
